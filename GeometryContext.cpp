...
GeometryContext* GeometryContext::instance = NULL; 

GeometryContext* GeometryContext::getInstance(iGeom_Instance& igm_p, InputDeck& deck_p) {
  if (!instance) instance = new GeometryContext(igm_p, deck_p);
  return instance;
}

GeometryContext* GeometryContext::getInstance() {
  // if (!instance) throw some sort of error idk how this works tho
  return instance;
}

GeometryContext::GeometryContext( iGeom_Instance& igm_p, InputDeck& deck_p ) :
